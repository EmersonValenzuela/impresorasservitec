...
<body id="home" class="background bg1">
	...
	<div class="theme-layout boxed">
					...
					<div class="header-sec">
						<div class="col-md-6">
							<div class="app-header-info">
								...
								<h1>IMPRESORAS</h1>
								<h2>¿Impresora dañada? ¿No enciende?¿?</h2>
		...
		<section class="block no-padding dark">
			<ul class="clients" id="carousal">
				<li><a href="#" title=""><img src="images/hp.png" alt="" height="90" /></a></li>
				<li><a href="#" title=""><img src="images/epson.png" alt="" height="90"></a></li>
				<li><a href="#" title=""><img src="images/canon.png" alt="" height="90" /></a></li>
				<li><a href="#" title=""><img src="images/dell.png" alt="" height="90" /></a></li>
				<li><a href="#" title=""><img src="images/sony.png" alt="" height="90" /></a></li>
			</ul>
		</section>
	...
	<section class="block dark">
				...
				<div class="container">
					<div class="prdct-mock">
						<div class="row">
							...
							<div class="col-md-6">
								<h3>¿Cuáles son los usos Principales de una <strong>Impresora</strong>?</h3>
								<p>Escanear, fotocopiar, ampliar o reducir el original y, por supuesto, imprimir; son algunas de las más importantes, además, existen distintos aspectos que debes tener en cuenta si lo que deseas es adquirir una.</p>
								<p>Otros aspectos relevantes que podemos destacar son el nivel de energía que utiliza y la calidad al momento de desempeñar cada una de sus funciones.</p>
							</div>
						</div>
					</div><!-- Product Mockup -->
				</div>
		...
		<section class="block remove-top dark" id="blog">
            ...
            SELECT *
            FROM `servicios` 
            WHERE id_categoria_servicio = 16 and id_servicio= 66 ORDER BY `id_servicio` DESC");
			...
			?>
				<div class="cool-features">
					...
					<div class="prdct-mockup-info">
						...
						<p><?= utf8_encode(getShortedString($row['descripcion'],150)); ?></p>
					</div>
				</div><!-- Cool Features -->
			...
			<div class="layer">
				...
				<div class="container">
					<div class="text-block2">
						<span>¿Necesitas un Experto para Impresora u otro dispositivo? </span>
